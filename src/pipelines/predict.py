...
def preprocess_data(data: pd.DataFrame):
    """
    Processa dados categóricos e os converte para valores numéricos.

    Args:
        data (pd.DataFrame): Dados de entrada que podem conter variáveis categóricas.

    Returns:
        pd.DataFrame: Dados de entrada com variáveis categóricas convertidas em numéricas.
    """
    # Inicializar o codificador de rótulos
    label_encoder = LabelEncoder()

    # Converter todas as colunas do tipo objeto (strings) em valores numéricos
...
def predict_batch(
    ...
    predictions = make_predictions(model, data_preprocessed)
